...
const UITextData: UITextObj[] = [
    ...
    },
    {
        ...
        getInfo: "ℹ️ [۱/۶] دریافت اطلاعات",
        downloadVideo: "📥 [۲/۶] دانلود MP4",
        convertToAudio: "🎙 [۳/۶] تبدیل به MP3",
        generateCover: "📸 [۴/۶] ساخت کاور",
        setMeta: "🖋 [۵/۶] ثبت اطلاعات آهنگ",
        upload: "📤 [۶/۶] آپلود به تلگرام",
        ...
        fileSizeOver50: "❌ حجم فایل بیشتر از ۵۰ MB است",
